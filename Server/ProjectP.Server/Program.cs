...
// ── T-D6-010: 히어로/스킬 데이터 API 스텁 ───────────────────────────────

// 인메모리 HeroData (HeroData.json과 동일 스키마)
var heroDataDb = new List<HeroMasterDto>
{
    new(10001, "견습 기사 아서", "Heroes/Knight_Arthur", 3, 5001,
        new StatDto(1000, 100, 20), new StatDto(200, 15, 5), 1.5f, 0.1f),
    new(10002, "성녀 에이다",    "Heroes/Healer_Ada",    4, 5002,
        new StatDto(800,  70, 15),  new StatDto(150, 10, 4), 2.0f, 0.08f),
    new(10003, "수호자 브리트",  "Heroes/Guardian_Brit", 3, 5003,
        new StatDto(1200, 80, 35),  new StatDto(250, 10, 8), 2.0f, 0.1f),
    new(10004, "전사 크롬",      "Heroes/Warrior_Crom",  2, 5004,
        new StatDto(900, 120, 18),  new StatDto(180, 18, 4), 1.8f, 0.12f),
    new(10005, "암살자 레이",    "Heroes/Assassin_Ray",  4, 5005,
        new StatDto(700, 150, 10),  new StatDto(130, 22, 3), 1.2f, 0.15f),
};

// 인메모리 SkillData (SkillData.json과 동일 스키마)
var skillDataDb = new List<SkillMasterDto>
{
    ...
    new(5002, "힐링 라이트", "Effects/Skills/HealLight",  "Heal",   "Single", 1, 2.0f,
        new List<SkillEffectDto>()),
    new(5003, "수호의 방패", "Effects/Skills/Shield",     "Shield", "Single", 1, 1.8f,
        new List<SkillEffectDto>()),
